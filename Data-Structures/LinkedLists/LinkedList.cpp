...
LinkedList<T>::LinkedList(const LinkedList<T>& other) {
    ...
    impl::LinkedListNode<T>* iter = other.head;
    impl::LinkedListNode<T>* new_list_iter = new impl::LinkedListNode<T>();
    ...
    iter = iter->next;
    while (iter != nullptr) {
        impl::LinkedListNode<T>* temp = new impl::LinkedListNode<T>();
